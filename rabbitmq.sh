# https://rabbitmq.com/install-debian.html#apt-quick-start-cloudsmith
...
## Add apt repositories maintained by Team RabbitMQ [22.04 jammy, 20.04 focal, 18.04 bionic]
...
# Previous Error in Erlang VM Installation
